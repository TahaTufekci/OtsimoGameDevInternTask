...
namespace Managers
{
    ...
    public class AudioManager : MonoBehaviour {
        ...
        public void PlaySound(string name)
        {
            ...
            {
                Debug.Log("Sound by the name " + name + " is not found! Issues occured at AudioManager.PlaySound()");
            }
        }
        ...
        public void StopSound(string name)
        {
            ...
            {
                Debug.Log("Sound by the name " + name + " is not found! Issues occured at AudioManager.StopSound()");
            }
        }
